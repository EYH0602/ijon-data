...
MemoryAccess::MemoryAccess(SMBEngine &engine, uint8_t *value) : engine(engine) {
  this->value = value;
}
...
MemoryAccess &MemoryAccess::operator++(int unused) { return ++(*this); }
...
MemoryAccess::operator uint8_t() { return *value; }
